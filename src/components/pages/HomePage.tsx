...
export default function HomePage() {
  ...
  useEffect(() => {
    const fetchHotspots = async () => {
      try {
        const response = await fetch("https://singbirds.net/api/hotspots/");
  ...
  useEffect(() => {
    const fetchBirds = async () => {
      if (selectedHotspot) {
        try {
          const response = await fetch(`https://singbirds.net/api/hotspots/${selectedHotspot.hotspot_id}/birds/`);
